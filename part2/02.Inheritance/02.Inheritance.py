...
class Manager(empeloyee):
    def __init__(self , fname , lname , salary , emps = None):# emps = None yani bdadn gharare 
        #attribute hayi ro daryaft konim (muteable things mesl list va dict)
    ...
    def add_emp(self , emp):# add kardan emp be zir majmooe manager
...
dev2 = developer('sara', 'saree', 18000 , 'Json')
